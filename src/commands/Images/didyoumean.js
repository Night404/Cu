...
Usage:
didyoumean \`first text; second text\`**`)
  ...
  message.channel.send("Please wait")
   ...
   let image = await alexclient.image.didyoumean({top: newArgs[0],bottom: newArgs[1]});
   let attachment = new Discord.MessageAttachment(image, "didyoumean.png");
